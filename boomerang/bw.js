...
(function() {
	...
	impl = {
		...
		user_ip: "",
		block_beacon: false,
		test_https: true,  //Kanonika htan false.To allaksa se true.
		cookie_exp: 90,    // kanonika htan  7 * 86400 = 7 hmeres. To allaksa se 1.5 lepto gia na anixneuw allages.
		cookie: "BA",
	...
	BOOMR.plugins.BW = {
		...
		run: function() {
			...
			if ( !impl.test_https && a.protocol === "https:") {                              //OXI HTTPS???????
